# Ordem Paranormal RPG — Documentação do Sistema

Guia completo de **regras do sistema**, uso das fichas, ferramentas do Mestre,
fórmulas e API. Para **instalação e primeiros passos**, veja o [README.md](README.md).

> **Conteúdo não oficial**, publicado sob a [Licença da Comunidade de Ordem Paranormal](https://ordemparanormal.com.br/licenca).
> Os compêndios são distribuídos **vazios** — adicione apenas conteúdo original/homebrew de sua autoria.

**Sumário:** [Modo de regras](#modo-de-regras-padrão--sobrevivendo-ao-horror) · [Guia de uso](#guia-de-uso) · [Ferramentas do Mestre](#ferramentas-do-mestre) · [Conteúdo e compartilhamento](#conteúdo-e-compartilhamento) · [Fórmulas](#fórmulas-status--dados) · [Referência rápida](#referência-rápida) · [API](#api-para-macros-e-console) · [Estrutura de arquivos](#estrutura-de-arquivos-desenvolvimento)
...
- Botão **+** em *Inventário → Condições* abre o **seletor de condições**.
...
> ⚠️ Adicione aos compêndios **apenas conteúdo original ou homebrew de sua autoria**. Não reproduza textos, imagens ou estatísticas dos livros oficiais (ver [licença.md](licença.md)).
...
| `condicoes.js` | Catálogo das 38 condições com efeitos automáticos |
...
| `packs/` | Compêndios do sistema (distribuídos vazios) |
...
> Ver também: [README.md](README.md) · [licença.md](licença.md) · [LICENSE](LICENSE)
